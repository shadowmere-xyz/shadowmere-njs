...
export default function Ports(props: any){
    ...
    return (
        <div className="ports-filter flex flex-col gap-2 xl:gap-4">
                ...
                <select title="Ports" value={props.valuePort} name="ports" id="port-selection" onChange={handleChange} className="relative puertos form-select rounded-md overflow-scroll border-gray-300 mx-2 text-[#303030] dark:text-[#cfcfcf] dark:border-0 dark:bg-[#303030] outline-none cursor-pointer">
