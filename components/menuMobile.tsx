...
export default function MenuMobile(props: any) {
    ...
    return (
        <div className={("modal-menu-mobile w-full h-auto bg-black/50 z-10 fixed top-0 pointer-events-auto ") + (props.open ? '' : 'hidden')} >
            <div className="menu-mobile absolute w-full h-auto bg-white dark:bg-[#212121] right-0 xl:hidden flex flex-col items-center justify-between transition-transform ease-in-out duration-150 top-20 rounded-b-2xl shadow-lg">
                <div className="w-full h-auto flex flex-col items-center gap-4 py-4 px-4">
                    <div className="w-full h-auto flex flex-col items-center justify-between gap-4 py-4 px-4">
                        ...
                        <button onClick={() => setTabActive('home')} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            <a className="w-full h-full flex items-center justify-center" href={'/'}>Home</a>
                        </button>

                        <button onClick={() => setTabActive('about')} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            <a className="w-full h-full flex items-center justify-center" href={'/about'}>About</a>
                        </button>

                        <button onClick={() => setTabActive('why')} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            <a className="w-full h-full flex items-center justify-center" href={'/why-shadowmere'}>Why Shadowmere?</a>
                        </button>

                        <button onClick={() => setTabActive('support')} className="relative dark:text-[#cfcfcf] font-medium group w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] dark:bg-[#1B1B1B] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            <a className="w-full h-full flex items-center justify-center" href={'/support-us'}>
                                <div className="relative w-auto h-auto px-2 ">
                                    Support Us
                                    <span className="absolute animate-pulse duration-100 p-1 bg-[#dc2626] top-[2px] -right-6 text-[8px] text-white rounded-sm">NEW</span>
                                </div>
                            </a>
                        </button>

                        <button onClick={() => setTabActive('sub')} className="relative dark:text-[#cfcfcf] font-medium group w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] dark:bg-[#1B1B1B] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            <a className="w-full h-full flex items-center justify-center" href={'/subscription'}>
                                <div className="relative w-auto h-auto px-2 ">Subscription
                                    <span className="absolute animate-pulse duration-100 p-1 bg-[#dc2626] top-[2px] -right-6 text-[8px] text-white rounded-sm">NEW</span>
                                </div>
                            </a>
                        </button>

                        <button className="button-fork w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#303030] hover:bg-[#444444] active:bg-[#303030] dark:bg-[#cfcfcf] dark:hover:bg-[#bfbfbf] dark:active:bg-white dark:transition-colors text-white gap-2">
                            <a className="w-full h-full flex items-center justify-center" href='https://github.com/jadolg/shadowmere' target={'_blank'} rel="noreferrer">
                    ...
                    <span className="font-twemoji align-baseline text-[#303030] dark:text-[#cfcfcf]">Made with ❤️ in Europe 🇪🇺 by Akiel</span>
                </div>
            </div>
        </div>
    )
