            ...
            <div className="menu-mobile absolute w-full h-auto bg-white dark:bg-[#212121] right-0 xl:hidden flex flex-col items-center justify-between transition-transform ease-in-out duration-150 top-20 shadow-lg border-b border-[#e0e0e0] dark:border-[#303030]">
                <div className="w-full h-auto flex flex-col items-center gap-4 py-4 px-4">
                    ...
                    <Link href={"/subscription"}></Link>
                        ...
                        <Link href={"/"} onClick={() => props.handleOpen()} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                        Home</Link>

                        <Link href={"/about"} onClick={() => props.handleOpen()} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                        About</Link>

                        <Link href={"/why-shadowmere"} onClick={() => props.handleOpen()} className="text-base dark:text-[#cfcfcf] font-medium w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] hover:bg-[#D7D7D7] dark:bg-[#1B1B1B] dark:hover:bg-[#111111] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                            Why Shadowmere?
                        </Link>

                        <Link href={"/support-us"} onClick={() => props.handleOpen()} className="relative dark:text-[#cfcfcf] font-medium group w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] dark:bg-[#1B1B1B] cursor-pointer transition-colors transition-transform active:scale-[99%]">
                        ...
                        <Link href={"/subscription"} onClick={() => props.handleOpen()} className="relative dark:text-[#cfcfcf] font-medium group w-full h-12 flex items-center justify-center px-5 rounded-md bg-[#EBEBEB] dark:bg-[#1B1B1B] cursor-pointer transition-colors transition-transform active:scale-[99%]">
