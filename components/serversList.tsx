...
export default function ServersList() {
    ...
    if (data.count == 0){
        return (
            ...
            <svg className='w-32 h-auto dark:fill-[#cfcfcf] mr-4' viewBox="0 0 44 43">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M25.082 10.9126L34.417 21.9004L37.3057 33.8857L22.4468 42.4766L20.1836 41.1367L19.4541 40.1689L17.7715 39.7073L13.022 36.8784L15.5679 29.3894L19.3052 24.0742L18.0098 19.9946L18.4268 23.9849L10.6396 27.1414L7.76611 30.0596L5.94971 30.387L4.71436 28.511L4.20801 28.4216L3.99951 27.3049L10.9375 12.3716L16.3125 8.02417L18.6499 6.1333L17.8906 9.61719L25.082 10.9126ZM14 19C15.1045 19 16 18.1045 16 17C16 15.8955 15.1045 15 14 15C12.8955 15 12 15.8955 12 17C12 18.1045 12.8955 19 14 19Z" />
