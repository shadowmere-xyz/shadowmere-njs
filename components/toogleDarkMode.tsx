    ...
    return (
        <div>
            <div title='Theme Toggler' onClick={() => handleMenu()} id="toggle" className="custom-toggle overflow-visible relative w-auto h-auto cursor-pointer">
                ...
                <div ref={ref} className={('absolute w-auto h-auto top-[72px] left-0 bg-white dark:bg-[#212121] dark:text-[#cfcfcf] rounded-md shadow-lg flex flex-col mx-auto p-2 gap-2 ') + (open ? '' : 'hidden')}>
