...
export default function Sidebar(props: any) {
	...
	return (
		<div className="sidebar col-span-12 xl:col-span-3 w-auto h-fit 2xl:h-fit mb-4 bg-white dark:bg-[#212121] dark:text-[#cfcfcf]  flex flex-col xl:flex-col gap-6 p-4 rounded-lg border border-[#e0e0e0] dark:border-[#303030]  ">
			...
			<button
				onClick={handleClick}
				className="button-reset w-auto h-12 flex gap-2 items-center justify-center px-5 rounded-md bg-[#212121] hover:bg-[#444444] active:bg-[#303030] dark:bg-[#303030] dark:hover:bg-[#3a3a3a] dark:active:bg-white dark:transition-colors text-white border dark:border-[#3a3a3a]">
				<svg
					xmlns="http://www.w3.org/2000/svg"
